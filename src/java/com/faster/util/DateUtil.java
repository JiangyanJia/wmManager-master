...
public class DateUtil {
     ...
     * @return 相差月数
     */
    public static Long getDistanceMonth(String start, String ends) {
        long days = 0;
...
//            System.out.println(tempStart.getWeekYear()+"=="+begin.getMonth());
//            days+= (getDaysByYearMonth(tempStart.getWeekYear(),begin.getMonth()));
        }
        return days;
    }
     ...
     * @return 相差月数集合
     */
    public static List<String> getMonths(String start, String ends) {
