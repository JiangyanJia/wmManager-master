...
<html>
    ...
    <body>
        <div class="x-left">
            ...
            <table class="layui-table" id="bindList" lay-data="{url:'${BASE}/data/mfunc/mfuncBindRolelist?fid=${param.fid}&pid=${param.pid}',height: 'full-105', cellMinWidth: 80, page: true}"  lay-filter="bindList">
                <thead>
                    <tr>
        ...
        <script>
            layui.use(['laydate', 'table', 'form'], function () {
                ...
                $("#userwh").on("click", function (e) {
                    ...
                    $.post("${BASE}/func/mfunc/bindRole?fid=${param.fid}&pid=${param.pid}&rid=" + ulist, function (resp) {
                        if (resp.err == 0) {
                            layer.msg("绑定角色成功");
                            setTimeout(function () {
