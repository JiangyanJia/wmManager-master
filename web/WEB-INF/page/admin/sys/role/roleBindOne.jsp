...
<html>
    ...
    <body>
        <div class="x-left">
            ...
            <table class="layui-table" id="userList" lay-data="{url:'${BASE}/data/role/bindOneList?rid='+${param.rid},height: 'full-120', cellMinWidth: 80, page: true}"  lay-filter="userList">
                <thead>
                    <tr>
                        <th lay-data="{type:'checkbox'}"></th>
                        <th lay-data="{field:'uname'}">账号</th>
        ...
        <script>
            layui.use(['laydate', 'table', 'form'], function () {
                ...
                $("#userwh").on("click", function (e) {
                    ...
                    $.post("${BASE}/func/role/instOneRole?rid=${param.rid}&ulist=" + ulist, function (resp) {
                        if (resp.err == 0) {
