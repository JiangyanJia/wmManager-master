...
<html>
    ...
    <body>
        <div class="x-left">
            ...
            <table class="layui-table" id="userList" lay-data="{url:'${BASE}/data/role/userwhlist?rid='+${param.rid},height: 'full-50', cellMinWidth: 80, page: true}"  lay-filter="userList">
                <thead>
                    <tr>
                        <th lay-data="{type:'checkbox'}"></th>
                        <th lay-data="{field:'userid'}">账号</th>
                        <th lay-data="{field:'uname'}">真实姓名</th>
        ...
        <script>
            layui.use(['laydate', 'table', 'form'], function () {
                ...
                $("#userwh").on("click", function (e) {
                    ...
                    $.post("${BASE}/func/role/urole?rid=${param.rid}&ulist=" + ulist, function (resp) {
                        if (resp.err == 0) {
