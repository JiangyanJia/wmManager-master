                ...
                layui.use("upload", function (o) {
                    ...
                    o.render({
                        url: r.url, method: r.type, elem: e(n).find("input")[0], done: function (e) {
                            e.path != "" ? (e.data = e.data || {}, v.call(t, "img", {
                                    src:localStorage.defimgservice+'/'+ e.path[0],
                                    alt: e.data.title
                                }, a)) : i.msg(e.msg || "上传失败")
                        }
                    })
